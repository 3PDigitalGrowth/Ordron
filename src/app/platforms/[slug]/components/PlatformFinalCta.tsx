...
export function PlatformFinalCta({ platform }: Props) {
  return (
          ...
          <div className="max-w-2xl">
            ...
            <Reveal delay={0.05}>
              <h2 className="mt-4 text-balance text-white">
                Ready to see where {platform.name} is costing you the most?
              </h2>
            </Reveal>
            <Reveal delay={0.1}>
              <p className="mt-5 text-lg leading-relaxed text-white/72">
                Book a Roadmap and we shadow your {platform.name} workflows
